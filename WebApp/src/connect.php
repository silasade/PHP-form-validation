<?php 
    ...
    if($name=="" || $email=="" || $email==""|| $password==""|| $number==""|| $gender=="" || $about=="" || $zip=="" ){
        ...
        $query =  "INSERT INTO login (name,email,password,number,gender,zip,about)
            VALUES('$name', '$email', '$password', '$number', '$gender','$zip','$about')";
